...
const footerLinks = {
  explore: [
    ...
    { label: "Solutions", href: "#accessories" },
  ],
  about: [
        ...
        <div className="grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Resilient Unified Decision & Risk Analytics. Network-based game-theoretic modeling of financial infrastructure for systemic risk prediction and prevention.
            </p>
          </div>
