...
const accessories = [
  {
    id: 1,
    name: "Core Platform",
    description: "Network analysis and systemic risk monitoring for financial institutions",
    price: "Enterprise",
  ...
  },
  {
    ...
    description: "Comprehensive policy stress-testing and compliance tools for regulators",
    price: "Custom",
  ...
  },
  {
    id: 3,
    name: "CCP Module",
    description: "Dynamic margin calibration and counterparty risk management for clearing houses",
    price: "Contact",
